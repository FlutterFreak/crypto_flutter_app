...
part of 'coinDetailsResponseModel.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CoinDetailsResponseModel _$CoinDetailsResponseModelFromJson(
    Map<String, dynamic> json) {
  return CoinDetailsResponseModel(
...
Map<String, dynamic> _$CoinDetailsResponseModelToJson(
        CoinDetailsResponseModel instance) =>
    <String, dynamic>{
      'id': instance.id,
