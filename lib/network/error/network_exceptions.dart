...
class NetworkExceptions with _$NetworkExceptions {
        ...
        if (error is DioError) {
          switch (error.type) {
            ...
            case DioErrorType.response:
              var response = error.response!.data['error'].toString();
  ...
  static String getErrorMessage(NetworkExceptions networkExceptions) {
    ...
    networkExceptions.when(notImplemented: () {
      ...
      errorMessage = error != null ? error : "Internal Server Error";
    }, notFound: (error) {
      errorMessage = error == null ? 'Not Found' : error;
    }, serviceUnavailable: () {
      errorMessage = "Service unavailable";
    }, methodNotAllowed: () {
      errorMessage = "Method Allowed";
    }, badRequest: (error) {
      errorMessage = error != null ? error : "Bad request";
    }, unauthorisedRequest: (error) {
      errorMessage = error != null ? error : "Unauthorised request";
    }, unexpectedError: () {
      ...
      errorMessage = error != null ? error : 'Received invalid status code';
    }, formatException: () {
